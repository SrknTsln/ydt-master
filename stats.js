...
function showStatsPage() {
    ...
    const grammarModules = [
        { id: 'gr', label: 'English Tenses',      icon: '⏱️', color: '#4f46e5', total: 17,  fnName: "openGrammarSection('overview')" },
        { id: 'mo', label: 'Modals',               icon: '⚡', color: '#d97706', total: 10,  fnName: "openModalsSection('overview')" },
        { id: 'pr', label: 'Pronouns',             icon: '👤', color: '#0369a1', total: 8,   fnName: "openPronounsSection('overview')" },
        { id: 'pa', label: 'Active / Passive',     icon: '🔄', color: '#16a34a', total: 10,  fnName: "openPassiveSection('overview')" },
        { id: 'co', label: 'Conditionals',         icon: '🔀', color: '#7c3aed', total: 12,  fnName: "openConditionalsSection('overview')" },
        { id: 're', label: 'Relative Clauses',     icon: '🔗', color: '#0891b2', total: 10,  fnName: "openRelativeSection('overview')" },
        { id: 'no', label: 'Noun Clauses',         icon: '💬', color: '#be185d', total: 10,  fnName: "openNounSection('overview')" },
        { id: 'cj', label: 'Adverbial Clauses',    icon: '🌿', color: '#16a34a', total: 11,  fnName: "openConjSection('overview')" },
        { id: 'ge', label: 'Gerunds & Infinitives',icon: '📝', color: '#e63946', total: 10,  fnName: "openGerundSection('overview')" },
        { id: 'aa', label: 'Adjectives & Adverbs', icon: '🔵', color: '#2563eb', total: 8,   fnName: "openAdjAdvSection('overview')" },
        { id: 'tq', label: 'Tag Q. & Quantifiers', icon: '❓', color: '#9333ea', total: 8,   fnName: "openTagQuantSection('overview')" },
    ];
    ...
    if (gmListEl) {
        ...
        gmListEl.innerHTML = grammarModules.map(m => {
            ...
            return `<div class="sp-gm-row" data-action="${m.fnName}">
